...
*/
(function(){var e=w.URL.createObjectURL(new Blob(["(",function(){self.onmessage=function(a){return self.postMessage({index:a.data.index,data:eval("(function(func){return func;})("+a.data.func+")").apply(null,a.data.args)})}}.toString(),")()"],{type:"application/javascript"})),d=function(){this.workers={}};d.prototype.prepare=function(a){var c=[];1<arguments.length&&Array.prototype.push.apply(c,arguments);c.shift();var b=Object.keys(this.workers).length;this.workers["!"+b]={worker:new Worker(e),func:a,
