...
var b=-Math.abs(Object.keys(this.workers).length+1),c=[];1<arguments.length&&(Array.prototype.push.apply(c,arguments),c=g(c,1));this.workers[d(b)]={worker:new Worker(h),args:c,init:function(a){null==this.worker.onmessage&&(this.worker.onmessage=function(b){return a(b.data)});this.worker.postMessage({func:this.func.toString(),args:this.args})},func:a};this.pid--;return b},restore:function(a,b){a=d(a);if(null!=this.workers[a]){null!=b&&(this.workers[a].func=b);var c=[];2<arguments.length&&(Array.prototype.push.apply(c,
arguments),c=g(c,2),this.workers[a].args=c)}else throw Error("Thread 0x"+a+" does not exist.");},execute:function(a,b){a=d(a);if(null!=this.workers[a])if("function"===typeof b)this.workers[a].init(function(a){return b(a)});else throw Error("Execute must require an async callback.");else throw Error("Thread 0x"+a+" does not exist.");},kill:function(a){a=d(a);if(null!=this.workers[a])this.workers[a].worker.terminate(),delete this.workers[a];else throw Error("Could not find thread 0x"+a+".");},killAll:function(){var a=
